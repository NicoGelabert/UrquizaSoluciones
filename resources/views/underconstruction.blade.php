...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title inertia>{{ config('app.name', 'Maldo Soluciones') }}</title>
    ...
    <main class="w-full mx-auto flex flex-col justify-evenly items-center h-screen px-10 under-construction">
